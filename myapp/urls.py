...
urlpatterns = [
    ...
    path('hasta/kayit/', views.patient_new_user, name='patient_register'),  # Make sure this is correct
    ...
    path("register_patient/", views.register_patient, name="register_patient"),  # Make sure this is added
